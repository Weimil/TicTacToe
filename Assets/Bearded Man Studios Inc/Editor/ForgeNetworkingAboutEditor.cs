...
namespace BeardedManStudios.Forge.Networking.UnityEditor
{
    public class ForgeNetworkingAboutEditor : EditorWindow
    {
        ...
        private string Version =>
            Resources.Load<TextAsset>(ForgeNetworkingEditor.EDITOR_RESOURCES_DIR + "/version").text;
        ...
        public void Setup()
        {
            titleContent = new GUIContent("Forge About");
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("GitHub", GUILayout.Height(50))) Application.OpenURL(EDITOR_GITHUB_LINK);

            if (GUILayout.Button("Join Discord", GUILayout.Height(50))) Application.OpenURL(EDITOR_DISCORD_LINK);

            if (GUILayout.Button("Forum Link", GUILayout.Height(50))) Application.OpenURL(EDITOR_FORUM_LINK);

            GUILayout.Space(10);

            if (GUILayout.Button("Leave Review", GUILayout.Height(50))) Application.OpenURL(EDITOR_ASSET_STORE_LINK);
