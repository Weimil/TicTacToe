...
namespace BeardedManStudios.Forge.Networking.UnityEditor
{
    ...
    public class ForgeEditorButton
    {
        ...
        public bool IsNetworkBehavior => ButtonName.EndsWith("Behavior");
        public bool IsNetworkObject => ButtonName.EndsWith("NetworkObject");

        public string StrippedSearchName =>
            IsNetworkBehavior ? ButtonName.Substring(0, ButtonName.IndexOf("Behavior")) :
        ...
        public bool RenderExposed(Action callback = null, bool ignoreButton = false)
        {
            ...
            if (CanRenderRPCS)
            {
                ...
                GUI.color = Color.green;
                if (GUI.Button(addRpcBtn, GUIContent.none)) RPCVariables.Add(new ForgeEditorRPCField());
