...
#pragma warning restore 0067
        [ForgeGeneratedField] private byte _fieldByte;
        ...
        [ForgeGeneratedField] private char _fieldChar;
        ...
        [ForgeGeneratedField] private short _fieldShort;
        ...
        [ForgeGeneratedField] private ushort _fieldUShort;
        ...
        [ForgeGeneratedField] private bool _fieldBool;
        ...
        [ForgeGeneratedField] private int _fieldInt;
        ...
        [ForgeGeneratedField] private uint _fieldUInt;
        ...
        [ForgeGeneratedField] private float _fieldFloat;
        ...
        [ForgeGeneratedField] private long _fieldLong;
        ...
        [ForgeGeneratedField] private ulong _fieldULong;
        ...
        [ForgeGeneratedField] private double _fieldDouble;
        ...
        public override void InterpolateUpdate()
        {
            ...
            if (fieldLongInterpolation.Enabled &&
                !fieldLongInterpolation.current.UnityNear(fieldLongInterpolation.target, 0.0015f))
                _fieldLong = (long) fieldLongInterpolation.Interpolate();
            //RunChange_fieldLong(fieldLongInterpolation.Timestep);
            if (fieldULongInterpolation.Enabled &&
                !fieldULongInterpolation.current.UnityNear(fieldULongInterpolation.target, 0.0015f))
                _fieldULong = (ulong) fieldULongInterpolation.Interpolate();
            //RunChange_fieldULong(fieldULongInterpolation.Timestep);
            if (fieldDoubleInterpolation.Enabled &&
                !fieldDoubleInterpolation.current.UnityNear(fieldDoubleInterpolation.target, 0.0015f))
        ...
        public TestNetworkObject() : base()
        {
            Initialize();
        }

        public TestNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0,
            byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata)
        {
            Initialize();
        }

        public TestNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId,
            frame)
        {
            Initialize();
        }
