...
{
    [GeneratedRPC(
        "{\"types\":[[][\"byte\"][\"char\"][\"short\"][\"ushort\"][\"bool\"][\"int\"][\"uint\"][\"float\"][\"long\"][\"ulong\"][\"double\"][\"string\"][\"byte[]\"][\"byte\", \"char\", \"short\", \"ushort\", \"bool\", \"int\", \"uint\", \"float\", \"long\", \"ulong\", \"double\", \"string\", \"byte[]\"]]")]
    [GeneratedRPCVariableNames(
        "{\"types\":[[][\"argByte\"][\"argChar\"][\"argShort\"][\"argUShort\"][\"argBool\"][\"argInt\"][\"argUInt\"][\"argFloat\"][\"argLong\"][\"argULong\"][\"argDouble\"][\"argString\"][\"argByteArray\"][\"argByte\", \"argChar\", \"argShort\", \"argUShort\", \"argBool\", \"argInt\", \"argUInt\", \"argFloat\", \"argLong\", \"argULong\", \"argDouble\", \"argString\", \"argByteArray\"]]")]
    public abstract partial class TestBehavior : NetworkBehavior
    {
        ...
        public override void Initialize(NetworkObject obj)
        {
            ...
            networkObject.RegisterRpc("FuncAll", FuncAll, typeof(byte), typeof(char), typeof(short), typeof(ushort),
                typeof(bool), typeof(int), typeof(uint), typeof(float), typeof(long), typeof(ulong), typeof(double),
