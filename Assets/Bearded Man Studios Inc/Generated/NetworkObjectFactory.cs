			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case ExampleProximityPlayerNetworkObject.IDENTITY:
						...
						break;
					case GameNetworkNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new GameNetworkNetworkObject(networker, id, frame);
						break;
					case NetBoardManagerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new NetBoardManagerNetworkObject(networker, id, frame);
						break;
