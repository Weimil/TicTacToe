...
namespace BeardedManStudios.Forge.Networking
{
    ...
    public abstract class NetworkObject
    {
        ...
        /// </summary>
        public uint MyPlayerId => Networker.Me.NetworkId;
        ...
        public static List<NetworkObject> NetworkObjects => networkObjects;
        ...
        public bool IsServer => Networker is IServer;
        ...
        private void Initialize(uint id = 0, ulong timestep = 0)
        {
            ...
            if (Networker.PendCreates)
                lock (PendingCreatesLock)
                {
                    if (
                        Networker
                            .PendCreates) // Check a second time in case Networker.PendCreates was changed while waiting for the lock
                    {
