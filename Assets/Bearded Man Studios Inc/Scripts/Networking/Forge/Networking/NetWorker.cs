...
namespace BeardedManStudios.Forge.Networking
{
    public abstract class NetWorker
    {
        ...
        internal bool ObjectCreatedRegistered => _objectCreated != null;
        ...
        public void FlushCreateActions(NetworkObject networkObject)
        {
            ...
            foreach (Action<NetworkObject> action in actions)
        ...
        private static void CloseLocalListingsClient()
        {
            ...
            {
                foreach (CachedUdpClient cachedUdpClient in localListingsClientList) cachedUdpClient.Client.Close();
            ...
            foreach (IPAddress ipAddress in GetLocalIPs())
            {
                ...
                Task.Queue(() =>
                {
                    ...
                    try
                    {
                        ...
                        {
                            BMSByte data = localListingsClient.Receive(ref groupEp, ref endpoint);
                            ...
                            {
                                BroadcastEndpoints ep = new BroadcastEndpoints(address, port, true);
