...
namespace BeardedManStudios.Forge.Networking.Lobby
{
    ...
    public class LobbyService : INetworkBehavior
    {
        ...
        /// Reference to my networking player
        /// </summary>
        public NetworkingPlayer MyNetworkingPlayer => networkObject.Networker.Me;
        ...
        private class DummyLobbyMaster : ILobbyMaster
        {
            ...
            public List<IClientMockPlayer> LobbyPlayers => _lobbyPlayers;

            private Dictionary<uint, IClientMockPlayer> _lobbyPlayersMap = new Dictionary<uint, IClientMockPlayer>();
            public Dictionary<uint, IClientMockPlayer> LobbyPlayersMap => _lobbyPlayersMap;

            private Dictionary<int, List<IClientMockPlayer>> _lobbyTeams =
                new Dictionary<int, List<IClientMockPlayer>>();

            public Dictionary<int, List<IClientMockPlayer>> LobbyTeams => _lobbyTeams;
        ...
        private void AssignName(RpcArgs args)
        {
            ...
            IClientMockPlayer player = GetClientMockPlayer(playerId);
        ...
        {
            uint playerId = args.GetNext<uint>();
            IClientMockPlayer player = CreateClientMockPlayer(playerId, "Player " + playerId);
        ...
        {
            DummyPlayer player = new DummyPlayer(playerId, playerName, 0, 0);
            return player;
        }
