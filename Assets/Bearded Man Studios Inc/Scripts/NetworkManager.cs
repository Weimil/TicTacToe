...
namespace BeardedManStudios.Forge.Networking.Unity
{
    public partial class NetworkManager : MonoBehaviour
    {
        ...
        public bool IsServer => Networker.IsServer;
            ...
            NetworkBehavior netBehavior = null)
        {
            ...
            NetworkBehavior[] components = obj.GetComponents<NetworkBehavior>();
            ...
            for (i = 0; i < components.Length; i++)
            {
                ...
                NetworkObject no = components[i].CreateNetworkObject(Networker, 0);
        ...
        public virtual void SceneReady(Scene scene, LoadSceneMode mode)
        {
            ...
            List<NetworkBehavior> behaviors = FindObjectsOfType<NetworkBehavior>().Where(b => !b.Initialized)
